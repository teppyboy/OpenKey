...
private:
	...
	HWND checkFixChromium, checkRememberTableCode, checkTempOffOpenKey, checkAllowOtherLanguages, checkUseTSFInput, checkForceUnloadTSFDLL, checkTSFBackspaceCompatibility, checkHideWindowsVietnameseIME;
	HWND hUpdateButton;
private:
	void initDialog();
